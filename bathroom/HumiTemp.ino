...
void reconnect() {
    ...
    while (!client.connected()) {
        ...
        if (client.connect("bathroom_humitemp")) {
            Serial.println("connected");
            // subscriber로 등록
            client.subscribe("home/bathroom/#");  // 구독 신청
        } else {
...
void publish() {
    ...
    client.publish("home/bathroom/humi", message);
    dtostrf(t, 5, 2, message);
    client.publish("home/bathroom/temp", message);
